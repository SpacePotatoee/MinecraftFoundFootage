...
public class PlayerManagerMixin {
    ...
    private BlockPos setSpawnPointPos(ServerPlayerEntity instance){
        if(BackroomsLevels.isInBackrooms(targetPlayer.method_48926().getRegistryKey())) {
    ...
    private @Nullable ServerWorld getCurrentWorld(MinecraftServer instance, RegistryKey<World> key){
        if(BackroomsLevels.isInBackrooms(targetPlayer.method_48926().getRegistryKey())) {
            return instance.getWorld(targetPlayer.method_48926().getRegistryKey());
        }
    ...
    private void respawn2(Args args){
        if(BackroomsLevels.isInBackrooms(targetPlayer.method_48926().getRegistryKey())) {
            ServerWorld currentWorld = this.server.getWorld(targetPlayer.method_48926().getRegistryKey());
