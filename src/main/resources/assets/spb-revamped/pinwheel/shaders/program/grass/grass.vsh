...
//    vec3 worldPos = localPos + cameraPos;
    ...
    float noiseAtCamera = perlinNoise(vec3(VeilCamera.CameraPosition.x, 0.0, VeilCamera.CameraPosition.z) * 0.05);

    gl_Position = VeilCamera.ProjMat * VeilCamera.ViewMat * vec4(localPos + vec3(0.0, noise*10 - noiseAtCamera*10, 0.0), 1.0);
