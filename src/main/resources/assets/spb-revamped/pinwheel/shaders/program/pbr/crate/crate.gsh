...
void main() {
    ...
    vec3 T = normalize((ProjMat * ModelViewMat * vec4(tangent, 0.0)).xyz);
    vec3 B = normalize((ProjMat * ModelViewMat * vec4(biTangent, 0.0)).xyz);
    vec3 N = normall[1];
