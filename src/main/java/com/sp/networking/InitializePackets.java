...
import com.sp.networking.C2S.ResetSync;
...
public class InitializePackets {
    ...
    public static final Identifier RESET_SYNC = new Identifier(SPBRevamped.MOD_ID, "reset_sync");
    ...
    public static void registerC2SPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(RESET_SYNC, ResetSync::receive);
    }
